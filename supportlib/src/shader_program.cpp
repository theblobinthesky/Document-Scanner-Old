...
shader_program docscanner::shader_programmer::compile_and_link(const std::string& vert_src, const std::string& frag_src) {
...
shader_program docscanner::shader_programmer::compile_and_link(const std::string& comp_src) {
